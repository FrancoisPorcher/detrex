...
from ..models.dino_wan2_2_vae_512 import model
...
train.output_dir = "./experiments/train_wan_vae_detector/dino_wan2.2_vae_16ep_512_lr_5e-5"
train.wandb.params.name = "dino_wan2.2_vae_16ep_512_lr_5e-5"
model.img_size = 512
