#!/usr/bin/env bash
#SBATCH --job-name=train_dinov3_detector
#SBATCH --output=/private/home/francoisporcher/detrex/experiments/train_dinov3_detector/logs/slurm_%j.out
#SBATCH --error=/private/home/francoisporcher/detrex/experiments/train_dinov3_detector/logs/slurm_%j.err
#SBATCH --nodes=1
#SBATCH --gres=gpu:8
...
EXPERIMENTS_DIR="/private/home/francoisporcher/detrex/experiments/train_dinov3_detector"
...
# Ensure repo root is importable for LazyConfig modules.
...
NUM_WORKERS=${NUM_WORKERS:-3}  # Changed from 8 to 3 (start conservative)

PYTHON_SCRIPT="/private/home/francoisporcher/detrex/projects/dino/train_net.py"
CONFIG_PATH="/private/home/francoisporcher/detrex/projects/dino/configs/dino-vitdet/dino_vitdet_dinov3_base_4scale_12ep.py"
