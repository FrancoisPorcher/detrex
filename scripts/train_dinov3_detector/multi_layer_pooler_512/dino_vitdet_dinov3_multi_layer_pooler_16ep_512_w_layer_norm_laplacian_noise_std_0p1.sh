#!/usr/bin/env bash
#SBATCH --job-name=dino_vitdet_dinov3_multi_layer_pooler_16ep_512_w_layer_norm_laplacian_noise_std_0p1
#SBATCH --output=/private/home/francoisporcher/detrex/experiments/logs/dino_vitdet_dinov3_multi_layer_pooler_16ep_512_w_layer_norm_laplacian_noise_std_0p1/slurm_%j.out
#SBATCH --error=/private/home/francoisporcher/detrex/experiments/logs/dino_vitdet_dinov3_multi_layer_pooler_16ep_512_w_layer_norm_laplacian_noise_std_0p1/slurm_%j.err
#SBATCH --nodes=1
#SBATCH --gres=gpu:8
...
CONFIG_PATH="/private/home/francoisporcher/detrex/projects/dino/configs/dino-vitdet/dino_vitdet_dinov3_multi_layer_pooler_16ep_512_w_layer_norm_laplacian_noise_std_0p1.py"
