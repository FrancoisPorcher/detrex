#!/usr/bin/env bash
#SBATCH --job-name=train_dinov3_lr_1e-4_res512
#SBATCH --output=/private/home/francoisporcher/detrex/experiments/logs/dino_vitdet_dinov3_upscale_12ep_512_4_2_1/logs/slurm_%j.out
#SBATCH --error=/private/home/francoisporcher/detrex/experiments/logs/dino_vitdet_dinov3_upscale_12ep_512_4_2_1/logs/slurm_%j.err
#SBATCH --nodes=1
#SBATCH --gres=gpu:8
...
CONFIG_PATH="/private/home/francoisporcher/detrex/projects/dino/configs/dino-vitdet/dino_vitdet_dinov3_upscale_12ep_512_4_2_1.py"
