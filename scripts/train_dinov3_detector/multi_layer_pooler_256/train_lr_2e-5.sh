#!/usr/bin/env bash
#SBATCH --job-name=train_dinov3_mlp_lr_2e-5_res256
#SBATCH --output=/private/home/francoisporcher/detrex/experiments/train_dinov3_detector/multi_layer_pooler_256/lr_2e-5/logs/slurm_%j.out
#SBATCH --error=/private/home/francoisporcher/detrex/experiments/train_dinov3_detector/multi_layer_pooler_256/lr_2e-5/logs/slurm_%j.err
#SBATCH --nodes=1
#SBATCH --gres=gpu:8
...
EXPERIMENTS_DIR="/private/home/francoisporcher/detrex/experiments/train_dinov3_detector/multi_layer_pooler_256/lr_2e-5"
...
CONFIG_PATH="/private/home/francoisporcher/detrex/projects/dino/configs/dino-vitdet/dino_vitdet_dinov3_multi_layer_pooler_12ep_256_lr_2e-5.py"
