#!/usr/bin/env bash
#SBATCH --job-name=train_dinov3_lr_5e-5_res256
#SBATCH --output=/private/home/francoisporcher/detrex/experiments/train_dinov3_detector/sweep_lr_256/lr_5e-5/logs/slurm_%j.out
#SBATCH --error=/private/home/francoisporcher/detrex/experiments/train_dinov3_detector/sweep_lr_256/lr_5e-5/logs/slurm_%j.err
#SBATCH --nodes=1
#SBATCH --gres=gpu:8
...
EXPERIMENTS_DIR="/private/home/francoisporcher/detrex/experiments/train_dinov3_detector/sweep_lr_256/lr_5e-5"
...
CONFIG_PATH="/private/home/francoisporcher/detrex/projects/dino/configs/dino-vitdet/dino_vitdet_dinov3_base_4scale_12ep_256_lr_5e-5.py"
