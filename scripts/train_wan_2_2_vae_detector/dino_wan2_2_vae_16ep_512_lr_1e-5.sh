#!/usr/bin/env bash
#SBATCH --job-name=dino_wan2_2_vae_16ep_512_lr_1e-5
#SBATCH --output=/private/home/francoisporcher/detrex/experiments/logs/dino_wan2_2_vae_16ep_512_lr_1e-5/slurm_%j.out
#SBATCH --error=/private/home/francoisporcher/detrex/experiments/logs/dino_wan2_2_vae_16ep_512_lr_1e-5/slurm_%j.err
#SBATCH --nodes=1
#SBATCH --gres=gpu:8
...
CONFIG_PATH="/private/home/francoisporcher/detrex/projects/dino/configs/dino-vitdet/dino_wan2_2_vae_16ep_512_lr_1e-5.py"
